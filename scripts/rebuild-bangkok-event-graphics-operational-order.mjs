...
async function main() {
  ...
  const rebuiltRows = [
    ...
    buildRow(lecture1Certi, { '정렬 순서': 5 }),
    buildRow(break1, { '정렬 순서': 6 }),
    buildRow(lecture2, { '정렬 순서': 7 }),
    buildRow(lecture2Certi, { '정렬 순서': 8 }),
    buildRow(lunch, { '정렬 순서': 9 }),
    buildRow(lecture3, { '정렬 순서': 10 }),
    buildRow(lecture3Certi, { '정렬 순서': 11 }),
    buildRow(break2, { '정렬 순서': 12 }),
    buildRow(lecture4, { '정렬 순서': 13 }),
    buildRow(lecture4Certi, { '정렬 순서': 14 }),
    buildRow(closing, { '정렬 순서': 15 }),
  ]
