...
const TASK_PROCESSES: TaskProcess[] = [
  {
    ...
    steps: [
      ...
      { number: '02', title: '외주 보정본 수령', detail: '외주 사진기사 보정본 → c_보정/에 바로 넣음 (b_수신 거치지 않음). ※ 사진 외주는 보정본으로 옴, 영상 외주와 다름.' },
      { number: '03', title: 'Bridge 1차 분류', detail: '자체촬영분을 한번 훑으며: reject(초점/흔들림)=삭제, 0점=보관(당장 안 씀), 1점=쓸 것. 레이팅 없음=아직 안 봄.' },
      { number: '04', title: '보정 (c_보정/)', detail: '1점 컷 중 보정 대상을 Photoshop/Lightroom으로 작업. 외주 보정본도 이미 여기에 있음.' },
      { number: '05', title: '공유 (d_공유/DAY별)', detail: 'c_보정/에서 외부 반출 가능한 것을 d_공유/DAY1/, DAY2/ 등 일자별로 정리. 누구에게든 전달 가능.' },
      { number: '06', title: 'SNS 콘텐츠 제작', detail: '보정/공유 사진을 가져와서 03_디지털/SNS/에서 그래픽 작업 (PSD→PNG).' },
    ],
  },
  {
    title: '영상 프로세스',
