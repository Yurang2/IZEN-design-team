  ...
  dc('01_PROJECT', '작업 과정 (프로젝트별)', [
    ...
    dc('IZ250001_CIS-Conference-2026', '풀세트 행사 프로젝트', [
      ...
      d('04_영상', [
        ...
        d('c_티저', [f('IZEN_CIS2026_티저_v01.prproj'), f('IZEN_CIS2026_티저_v01.mp4')]),
        d('d_강연소개', [f('IZEN_CIS2026_강연소개_Dr-Kim_v01.aep'), f('IZEN_CIS2026_강연소개_Dr-Kim_v01.mp4')]),
        dc('e_모션그래픽', '오프닝, 브레이크 등 → 완성본은 03_디지털/행사운영/에도 복사', [
          f('IZEN_CIS2026_오프닝_3D_v01.c4d'), f('IZEN_CIS2026_오프닝_v01.mp4'),
        ]),
        d('f_후기', [f('IZEN_CIS2026_후기_v01.prproj'), f('IZEN_CIS2026_후기_v01.mp4')]),
      ]),
      d('05_사진', [
        dc('a_자체촬영', '카메라 RAW/JPG 전량'),
        dc('b_수신', '타팀 핸드폰 등 (작업 필요한 소스)', [d('타팀')]),
        dc('c_선별', 'Bridge 1점 컷 (자체촬영+수신에서 고른 것)'),
        dc('d_보정', '우리 보정 + 외주 보정본 (여기서 DAY 분류)'),
        d('e_공유', [dc('DAY1', '1일차 공유 사진'), dc('DAY2', '2일차 공유 사진')]),
      ]),
