...
const SUBFOLDER_TREE: FolderTreeNode[] = [
  ...
  { label: '04_영상', value: '04_영상', children: [
    ...
    { label: '후기영상', value: '04_영상/후기영상' },
    { label: '홍보영상', value: '04_영상/홍보영상' },
    { label: '브랜딩영상', value: '04_영상/브랜딩영상' },
    { label: '모션그래픽', value: '04_영상/모션그래픽' },
    { label: '제품영상', value: '04_영상/제품영상' },
    { label: '회사소개영상', value: '04_영상/회사소개영상' },
  ] },
